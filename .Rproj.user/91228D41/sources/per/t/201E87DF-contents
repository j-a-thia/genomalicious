...
#' a ggplot object.
#'
#' @details DAPC involves fitting a discriminant analysis (DA) of among
#' population differences using PC axes as predictors. This approach was
#' made popular in the population genetics/molecular ecology community
#' following Jombart et al's (2010) paper. Patteron et al. (2006)
#' demosntrated that there are \emph(k)-1 PC axes for \emph(k) effective
#' populations in a genotype data set. Thia (2022) then demonstrated that the
#' only suitable PC axes for DA of genotype data are the leading \emph(k)-1
#' PC axes.
#'
