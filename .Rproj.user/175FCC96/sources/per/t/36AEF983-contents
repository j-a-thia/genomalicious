...
#'
#' @export
family_sim_qtl <- function(famGenos, numLoci, additiveVar, environVar){
  ...
  # Reassign values for variance components and loci
  Va_t <- additiveVar
  Ve_t <- environVar
  n <- numLoci
  ...
  # Falconer and MacKay: Introduction to Quantitative genetics, 3rd Ed., page 129
  # Va == 2pq[a + d(q-p)]^2
