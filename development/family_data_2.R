...
family_sim_data <- function(freqData, locusCol='LOCUS', freqCol='FREQ', numSims=100L){
  ...
  simFamily <- lapply(1:numSims, function(sim){
    ...
    sib.names <- paste0('S',sim,c('_sib_1.1_ind','_sib_1.2_ind','_sib_1_dam','_sib_1_sire'))
    ...
    hsib.names <- paste0(
      'S',sim,
      c('_hsib_1.1_ind','_hsib_1.2_ind',
        '_hsib_1_dam','_hsib_1.1_sire','_hsib_1.2_sire')
    )
    ...
    cus.names <- paste0(
      'S',sim,
      c('_cuz_1.1_ind','_cuz_1.2_ind',
        '_cuz_1.1_dam','_cuz_1.2_dam','_cuz_1.1_sire','_cuz_1.2_sire',
        '_cuz_1_gdam','_cuz_1_gsire')
    )
    ...
    hcuz.names <- c(
      paste0(
        'S',sim,
        c('_hcuz_1.1_ind','_hcuz_1.2_ind',
          '_hcuz_1.1_dam','_hcuz_1.2_dam','_hcuz_1.1_sire','_hcuz_1.2_sire',
          '_hcuz_1.1_gdam','hcuz_1.1_gsire','hcuz_1.2_gsire')
      )
    )
    ...
    foc.pairs.tab <- rbind(
      ...
      po.g1.1 %>% data.table(SIM=sim, SAMPLE=paste0('S',sim,'_po_2_ind')),
    ...
    po.g1.1 %>% data.table(SIM=sim, SAMPLE=paste0('S',sim,'_po_1_dam'))
